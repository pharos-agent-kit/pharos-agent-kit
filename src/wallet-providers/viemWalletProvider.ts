 ...
 */
export class ViemWalletProvider extends PharosWalletProvider {
  ...
  constructor(
    ...
    this.#publicClient = createPublicClient({
      chain: walletClient.chain || pharosDevnet, // Default to Pharos if no chain specified
      transport: http(),
    });
   ...
   */
  getNetwork(): Network {
    const chain = this.#walletClient.chain || pharosDevnet;
    return {
      protocolFamily: "pharos",
      chainId: String(chain.id),
      networkId: CHAIN_ID_TO_NETWORK_ID[chain.id],
    };
  }
